                ...
                <div className={`flex items-end justify-between gap-4 ${minimal ? 'mb-8' : 'mb-10'}`}>
                    ...
                    {summary && (
                        <div className="flex items-center gap-4 bg-slate-800/20 px-6 py-3 rounded-[24px] border border-slate-700/30 relative">
                            ...
                            {showMetrics && (
                                <div
                                    className="absolute left-0 sm:left-auto sm:right-0 top-[calc(100%+8px)] z-20 w-72 max-h-72 overflow-y-auto rounded-2xl border border-slate-700/70 bg-slate-950/95 p-4 shadow-2xl scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-slate-900/50"
